...
//#LTLFairness: [](AP(valid(hdr.bfsTag)))
type Ref;
type error=int;
...
var meta.local_metadata.first_visit:int;
var meta.local_metadata.failure_visit:int;
...
// Header header_bfs_t
var hdr.bfsTag:Ref;
var hdr.bfsTag.valid:bool;
var hdr.bfsTag.pkt_v1_curr:int;
var _old_hdr.bfsTag.pkt_v1_curr:int;
var hdr.bfsTag.pkt_v1_par:int;
var _old_hdr.bfsTag.pkt_v1_par:int;
var hdr.bfsTag.pkt_v2_curr:int;
var _old_hdr.bfsTag.pkt_v2_curr:int;
var hdr.bfsTag.pkt_v2_par:int;
var _old_hdr.bfsTag.pkt_v2_par:int;
var hdr.bfsTag.pkt_v3_curr:int;
var _old_hdr.bfsTag.pkt_v3_curr:int;
var hdr.bfsTag.pkt_v3_par:int;
var _old_hdr.bfsTag.pkt_v3_par:int;
var hdr.bfsTag.pkt_v4_curr:int;
var _old_hdr.bfsTag.pkt_v4_curr:int;
var hdr.bfsTag.pkt_v4_par:int;
var _old_hdr.bfsTag.pkt_v4_par:int;
...
var hdr.ff_tags.bfs_start:int;
var _old_hdr.ff_tags.bfs_start:int;
...
// Table send_in_ingress_0 Actionlist Declaration
type send_in_ingress_0.action;
const unique send_in_ingress_0.action.send_in : send_in_ingress_0.action;
var send_in_ingress_0.action_run : send_in_ingress_0.action;
var send_in_ingress_0.hit : bool;

// Table send_parent_0 Actionlist Declaration
type send_parent_0.action;
const unique send_parent_0.action.send_on_parent : send_parent_0.action;
var send_parent_0.action_run : send_parent_0.action;
var send_parent_0.hit : bool;
...
// Table start_bfs_0 Actionlist Declaration
type start_bfs_0.action;
const unique start_bfs_0.action.set_bfs_tags : start_bfs_0.action;
var start_bfs_0.action_run : start_bfs_0.action;
var start_bfs_0.hit : bool;
...
// Table _curr_par_eq_neq_ingress Actionlist Declaration
type _curr_par_eq_neq_ingress.action;
const unique _curr_par_eq_neq_ingress.action._set_next_port_0 : _curr_par_eq_neq_ingress.action;
var _curr_par_eq_neq_ingress.action_run : _curr_par_eq_neq_ingress.action;
var _curr_par_eq_neq_ingress.hit : bool;

// Table _curr_par_eq_zero Actionlist Declaration
type _curr_par_eq_zero.action;
const unique _curr_par_eq_zero.action._set_par_to_ingress_0 : _curr_par_eq_zero.action;
var _curr_par_eq_zero.action_run : _curr_par_eq_zero.action;
var _curr_par_eq_zero.hit : bool;

// Table _curr_par_neq_in Actionlist Declaration
type _curr_par_neq_in.action;
const unique _curr_par_neq_in.action._set_out_to_ingress_0 : _curr_par_neq_in.action;
var _curr_par_neq_in.action_run : _curr_par_neq_in.action;
var _curr_par_neq_in.hit : bool;

// Table _hit_depth Actionlist Declaration
type _hit_depth.action;
const unique _hit_depth.action._go_to_next_0 : _hit_depth.action;
...
// Action NoAction_34
procedure {:inline 1} NoAction_34()
{
}

// Action NoAction_35
procedure {:inline 1} NoAction_35()
{
}

// Action NoAction_36
procedure {:inline 1} NoAction_36()
{
}

// Action NoAction_37
procedure {:inline 1} NoAction_37()
{
}

// Action NoAction_38
procedure {:inline 1} NoAction_38()
{
}

// Action NoAction_39
procedure {:inline 1} NoAction_39()
{
}
procedure ULTIMATE.start()
	modifies _check_out_failed.action_run, _check_outport_status.action_run, _curr_par_eq_neq_ingress.action_run, _curr_par_eq_zero.action_run, _curr_par_neq_in.action_run, _hit_depth.action_run, _if_status.action_run, _jump_to_next.action_run, _old_hdr.bfsTag.pkt_v1_curr, _old_hdr.bfsTag.pkt_v1_par, _old_hdr.bfsTag.pkt_v2_curr, _old_hdr.bfsTag.pkt_v2_par, _old_hdr.bfsTag.pkt_v3_curr, _old_hdr.bfsTag.pkt_v3_par, _old_hdr.bfsTag.pkt_v4_curr, _old_hdr.bfsTag.pkt_v4_par, _old_hdr.ff_tags.bfs_start, _old_hdr.ff_tags.is_edge, _old_hdr.ff_tags.path_length, _old_hdr.ff_tags.preamble, _old_hdr.ff_tags.shortest_path, _out_eq_zero.action_run, _set_egress_port.action_run, _set_parent_out.action_run, _to_parent.action_run, _try_next.action_run, default_route_0.action_run, drop, emit, forward, fwd_parent_0.action_run, fwd_pkt_0.action_run, hdr.bfsTag.pkt_v1_curr, hdr.bfsTag.pkt_v1_par, hdr.bfsTag.pkt_v2_curr, hdr.bfsTag.pkt_v2_par, hdr.bfsTag.pkt_v3_curr, hdr.bfsTag.pkt_v3_par, hdr.bfsTag.pkt_v4_curr, hdr.bfsTag.pkt_v4_par, hdr.bfsTag.valid, hdr.ff_tags.bfs_start, hdr.ff_tags.is_edge, hdr.ff_tags.path_length, hdr.ff_tags.preamble, hdr.ff_tags.shortest_path, hdr.ff_tags.valid, meta.local_metadata.all_ports, meta.local_metadata.failure_visit, meta.local_metadata.first_visit, meta.local_metadata.if_out_failed, meta.local_metadata.is_completed, meta.local_metadata.out_port, meta.local_metadata.out_port_xor, meta.local_metadata.pkt_curr, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start, meta.local_metadata.starting_port, send_in_ingress_0.action_run, send_parent_0.action_run, set_out_port_0.action_run, standard_metadata.egress_spec, standard_metadata.ingress_port, start_bfs_0.action_run;
{
    call mainProcedure();
}
...
procedure _curr_par_eq_neq_ingress.action_run.limit();
    ensures(_curr_par_eq_neq_ingress.action_run==_curr_par_eq_neq_ingress.action._set_next_port_0);
	modifies _curr_par_eq_neq_ingress.action_run;

// Table _curr_par_eq_neq_ingress
procedure {:inline 1} _curr_par_eq_neq_ingress.apply()
	modifies meta.local_metadata.out_port, meta.local_metadata.pkt_curr;
{

    call _curr_par_eq_neq_ingress.apply_table_entry();

    action__set_next_port_0:
    if(_curr_par_eq_neq_ingress.action_run == _curr_par_eq_neq_ingress.action._set_next_port_0){
        call _set_next_port_0();
    }
}

// Table Entry _curr_par_eq_neq_ingress.apply_table_entry
procedure _curr_par_eq_neq_ingress.apply_table_entry();

// Table Exit _curr_par_eq_neq_ingress.apply_table_exit
procedure _curr_par_eq_neq_ingress.apply_table_exit();

procedure _curr_par_eq_zero.action_run.limit();
    ensures(_curr_par_eq_zero.action_run==_curr_par_eq_zero.action._set_par_to_ingress_0);
	modifies _curr_par_eq_zero.action_run;

// Table _curr_par_eq_zero
procedure {:inline 1} _curr_par_eq_zero.apply()
	modifies hdr.bfsTag.pkt_v1_par, meta.local_metadata.first_visit, meta.local_metadata.out_port, meta.local_metadata.pkt_par;
{

    call _curr_par_eq_zero.apply_table_entry();

    action__set_par_to_ingress_0:
    if(_curr_par_eq_zero.action_run == _curr_par_eq_zero.action._set_par_to_ingress_0){
        call _set_par_to_ingress_0();
    }
}

// Table Entry _curr_par_eq_zero.apply_table_entry
procedure _curr_par_eq_zero.apply_table_entry();

// Table Exit _curr_par_eq_zero.apply_table_exit
procedure _curr_par_eq_zero.apply_table_exit();

procedure _curr_par_neq_in.action_run.limit();
    ensures(_curr_par_neq_in.action_run==_curr_par_neq_in.action._set_out_to_ingress_0);
	modifies _curr_par_neq_in.action_run;

// Table _curr_par_neq_in
procedure {:inline 1} _curr_par_neq_in.apply()
	modifies meta.local_metadata.failure_visit, meta.local_metadata.out_port;
{

    call _curr_par_neq_in.apply_table_entry();

    action__set_out_to_ingress_0:
    if(_curr_par_neq_in.action_run == _curr_par_neq_in.action._set_out_to_ingress_0){
        call _set_out_to_ingress_0();
    }
}

// Table Entry _curr_par_neq_in.apply_table_entry
procedure _curr_par_neq_in.apply_table_entry();

// Table Exit _curr_par_neq_in.apply_table_exit
procedure _curr_par_neq_in.apply_table_exit();

// Action _go_to_next_0
procedure {:inline 1} _go_to_next_0()
	modifies meta.local_metadata.is_completed, meta.local_metadata.out_port, meta.local_metadata.pkt_curr;
{
    meta.local_metadata.out_port := meta.local_metadata.pkt_par;
    meta.local_metadata.pkt_curr := 0;
    meta.local_metadata.is_completed := 1;
}

procedure _hit_depth.action_run.limit();
    ensures(_hit_depth.action_run==_hit_depth.action._go_to_next_0);
	...
	modifies meta.local_metadata.is_completed, meta.local_metadata.out_port, meta.local_metadata.pkt_curr;
{
    ...
    action__go_to_next_0:
    if(_hit_depth.action_run == _hit_depth.action._go_to_next_0){
        call _go_to_next_0();
    }
}
...
procedure {:inline 1} _parser_ParserImpl()
	modifies drop, hdr.bfsTag.valid, hdr.ff_tags.valid, meta.local_metadata.pkt_curr, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start;
{
    call start();
}
...
procedure {:inline 1} _set_egress_port.apply()
	modifies meta.local_metadata.all_ports, meta.local_metadata.out_port, meta.local_metadata.starting_port;
{
    var _starting_port_meta_0.port_start:int;
    ...
    if(_set_egress_port.action_run == _set_egress_port.action._starting_port_meta_0){
        call _starting_port_meta_0(_starting_port_meta_0.port_start);
    }
}
...
// Action _set_out_to_ingress_0
procedure {:inline 1} _set_out_to_ingress_0()
	modifies meta.local_metadata.failure_visit, meta.local_metadata.out_port;
{
    meta.local_metadata.out_port := meta.local_metadata.out_port;
    meta.local_metadata.failure_visit := 1;
}

// Action _set_par_to_ingress_0
procedure {:inline 1} _set_par_to_ingress_0()
	modifies hdr.bfsTag.pkt_v1_par, meta.local_metadata.first_visit, meta.local_metadata.out_port, meta.local_metadata.pkt_par;
{
    meta.local_metadata.pkt_par := (standard_metadata.ingress_port%power_2_8());
    hdr.bfsTag.pkt_v1_par := meta.local_metadata.pkt_par;
    meta.local_metadata.out_port := (standard_metadata.ingress_port%power_2_8());
    meta.local_metadata.first_visit := 1;
}
...
procedure {:inline 1} _starting_port_meta_0(port_start:int)
...
procedure {:inline 1} fwd(_port:int)
	modifies forward, hdr.bfsTag.pkt_v1_curr, hdr.ff_tags.path_length, standard_metadata.egress_spec;
{
    standard_metadata.egress_spec := _port;
    forward := true;
    hdr.bfsTag.pkt_v1_curr := (_port%power_2_8());
...
procedure {:inline 1} fwd_pkt_0.apply()
	modifies forward, hdr.bfsTag.pkt_v1_curr, hdr.ff_tags.path_length, meta.local_metadata.all_ports, meta.local_metadata.starting_port, standard_metadata.egress_spec;
{
    var fwd._port:int;
    meta.local_metadata.starting_port := meta.local_metadata.starting_port;
    meta.local_metadata.all_ports := meta.local_metadata.all_ports;
...
procedure {:inline 1} havocProcedure()
	modifies _old_hdr.bfsTag.pkt_v1_curr, _old_hdr.bfsTag.pkt_v1_par, _old_hdr.bfsTag.pkt_v2_curr, _old_hdr.bfsTag.pkt_v2_par, _old_hdr.bfsTag.pkt_v3_curr, _old_hdr.bfsTag.pkt_v3_par, _old_hdr.bfsTag.pkt_v4_curr, _old_hdr.bfsTag.pkt_v4_par, _old_hdr.ff_tags.bfs_start, _old_hdr.ff_tags.is_edge, _old_hdr.ff_tags.path_length, _old_hdr.ff_tags.preamble, _old_hdr.ff_tags.shortest_path, emit, hdr.bfsTag.pkt_v1_curr, hdr.bfsTag.pkt_v1_par, hdr.bfsTag.pkt_v2_curr, hdr.bfsTag.pkt_v2_par, hdr.bfsTag.pkt_v3_curr, hdr.bfsTag.pkt_v3_par, hdr.bfsTag.pkt_v4_curr, hdr.bfsTag.pkt_v4_par, hdr.bfsTag.valid, hdr.ff_tags.bfs_start, hdr.ff_tags.is_edge, hdr.ff_tags.path_length, hdr.ff_tags.preamble, hdr.ff_tags.shortest_path, hdr.ff_tags.valid;
{
    hdr.bfsTag.valid := false;
    emit[hdr.bfsTag] := false;
    havoc hdr.bfsTag.pkt_v1_curr;
    assume(0 <= hdr.bfsTag.pkt_v1_curr && hdr.bfsTag.pkt_v1_curr <= power_2_8() );
    _old_hdr.bfsTag.pkt_v1_curr := hdr.bfsTag.pkt_v1_curr;
    havoc hdr.bfsTag.pkt_v1_par;
    assume(0 <= hdr.bfsTag.pkt_v1_par && hdr.bfsTag.pkt_v1_par <= power_2_8() );
    _old_hdr.bfsTag.pkt_v1_par := hdr.bfsTag.pkt_v1_par;
    havoc hdr.bfsTag.pkt_v2_curr;
    assume(0 <= hdr.bfsTag.pkt_v2_curr && hdr.bfsTag.pkt_v2_curr <= power_2_8() );
    _old_hdr.bfsTag.pkt_v2_curr := hdr.bfsTag.pkt_v2_curr;
    havoc hdr.bfsTag.pkt_v2_par;
    assume(0 <= hdr.bfsTag.pkt_v2_par && hdr.bfsTag.pkt_v2_par <= power_2_8() );
    _old_hdr.bfsTag.pkt_v2_par := hdr.bfsTag.pkt_v2_par;
    havoc hdr.bfsTag.pkt_v3_curr;
    assume(0 <= hdr.bfsTag.pkt_v3_curr && hdr.bfsTag.pkt_v3_curr <= power_2_8() );
    _old_hdr.bfsTag.pkt_v3_curr := hdr.bfsTag.pkt_v3_curr;
    havoc hdr.bfsTag.pkt_v3_par;
    assume(0 <= hdr.bfsTag.pkt_v3_par && hdr.bfsTag.pkt_v3_par <= power_2_8() );
    _old_hdr.bfsTag.pkt_v3_par := hdr.bfsTag.pkt_v3_par;
    havoc hdr.bfsTag.pkt_v4_curr;
    assume(0 <= hdr.bfsTag.pkt_v4_curr && hdr.bfsTag.pkt_v4_curr <= power_2_8() );
    _old_hdr.bfsTag.pkt_v4_curr := hdr.bfsTag.pkt_v4_curr;
    havoc hdr.bfsTag.pkt_v4_par;
    assume(0 <= hdr.bfsTag.pkt_v4_par && hdr.bfsTag.pkt_v4_par <= power_2_8() );
    _old_hdr.bfsTag.pkt_v4_par := hdr.bfsTag.pkt_v4_par;
    ...
    havoc hdr.ff_tags.bfs_start;
    assume(0 <= hdr.ff_tags.bfs_start && hdr.ff_tags.bfs_start <= power_2_1() );
    _old_hdr.ff_tags.bfs_start := hdr.ff_tags.bfs_start;
}

// Control ingress
procedure {:inline 1} ingress()
	modifies forward, hdr.bfsTag.pkt_v1_curr, hdr.bfsTag.pkt_v1_par, hdr.ff_tags.bfs_start, hdr.ff_tags.path_length, meta.local_metadata.all_ports, meta.local_metadata.failure_visit, meta.local_metadata.first_visit, meta.local_metadata.if_out_failed, meta.local_metadata.is_completed, meta.local_metadata.out_port, meta.local_metadata.out_port_xor, meta.local_metadata.pkt_curr, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start, meta.local_metadata.starting_port, standard_metadata.egress_spec, standard_metadata.ingress_port;
{
    if(hdr.bfsTag.valid){
        if((meta.local_metadata.pkt_start == 0)){
            call default_route_0.apply();
            if((meta.local_metadata.out_port == 0)){
                call start_bfs_0.apply();
            }
        }
        else{
            if(((meta.local_metadata.pkt_curr == 0)) && ((meta.local_metadata.pkt_par == 0))){
                call _curr_par_eq_zero.apply();
            }
            else{
                if(((meta.local_metadata.pkt_curr != standard_metadata.ingress_port)) && ((meta.local_metadata.pkt_par != standard_metadata.ingress_port))){
                    call _curr_par_neq_in.apply();
                }
                else{
                    call _curr_par_eq_neq_ingress.apply();
        ...
        if((meta.local_metadata.first_visit == 1)){
            call send_parent_0.apply();
        }
        if((meta.local_metadata.failure_visit == 1)){
            call send_in_ingress_0.apply();
        }
        if(((meta.local_metadata.first_visit == 0)) && ((meta.local_metadata.failure_visit == 0))){
            if((meta.local_metadata.is_completed == 0)){
...
procedure {:inline 1} main()
	modifies _old_hdr.bfsTag.pkt_v1_curr, _old_hdr.bfsTag.pkt_v1_par, _old_hdr.bfsTag.pkt_v2_curr, _old_hdr.bfsTag.pkt_v2_par, _old_hdr.bfsTag.pkt_v3_curr, _old_hdr.bfsTag.pkt_v3_par, _old_hdr.bfsTag.pkt_v4_curr, _old_hdr.bfsTag.pkt_v4_par, _old_hdr.ff_tags.bfs_start, _old_hdr.ff_tags.is_edge, _old_hdr.ff_tags.path_length, _old_hdr.ff_tags.preamble, _old_hdr.ff_tags.shortest_path, drop, emit, forward, hdr.bfsTag.pkt_v1_curr, hdr.bfsTag.pkt_v1_par, hdr.bfsTag.pkt_v2_curr, hdr.bfsTag.pkt_v2_par, hdr.bfsTag.pkt_v3_curr, hdr.bfsTag.pkt_v3_par, hdr.bfsTag.pkt_v4_curr, hdr.bfsTag.pkt_v4_par, hdr.bfsTag.valid, hdr.ff_tags.bfs_start, hdr.ff_tags.is_edge, hdr.ff_tags.path_length, hdr.ff_tags.preamble, hdr.ff_tags.shortest_path, hdr.ff_tags.valid, meta.local_metadata.all_ports, meta.local_metadata.failure_visit, meta.local_metadata.first_visit, meta.local_metadata.if_out_failed, meta.local_metadata.is_completed, meta.local_metadata.out_port, meta.local_metadata.out_port_xor, meta.local_metadata.pkt_curr, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start, meta.local_metadata.starting_port, standard_metadata.egress_spec, standard_metadata.ingress_port;
{
    call havocProcedure();
    call clear_drop();
    call clear_forward();
	...
	modifies _check_out_failed.action_run, _check_outport_status.action_run, _curr_par_eq_neq_ingress.action_run, _curr_par_eq_zero.action_run, _curr_par_neq_in.action_run, _hit_depth.action_run, _if_status.action_run, _jump_to_next.action_run, _old_hdr.bfsTag.pkt_v1_curr, _old_hdr.bfsTag.pkt_v1_par, _old_hdr.bfsTag.pkt_v2_curr, _old_hdr.bfsTag.pkt_v2_par, _old_hdr.bfsTag.pkt_v3_curr, _old_hdr.bfsTag.pkt_v3_par, _old_hdr.bfsTag.pkt_v4_curr, _old_hdr.bfsTag.pkt_v4_par, _old_hdr.ff_tags.bfs_start, _old_hdr.ff_tags.is_edge, _old_hdr.ff_tags.path_length, _old_hdr.ff_tags.preamble, _old_hdr.ff_tags.shortest_path, _out_eq_zero.action_run, _set_egress_port.action_run, _set_parent_out.action_run, _to_parent.action_run, _try_next.action_run, default_route_0.action_run, drop, emit, forward, fwd_parent_0.action_run, fwd_pkt_0.action_run, hdr.bfsTag.pkt_v1_curr, hdr.bfsTag.pkt_v1_par, hdr.bfsTag.pkt_v2_curr, hdr.bfsTag.pkt_v2_par, hdr.bfsTag.pkt_v3_curr, hdr.bfsTag.pkt_v3_par, hdr.bfsTag.pkt_v4_curr, hdr.bfsTag.pkt_v4_par, hdr.bfsTag.valid, hdr.ff_tags.bfs_start, hdr.ff_tags.is_edge, hdr.ff_tags.path_length, hdr.ff_tags.preamble, hdr.ff_tags.shortest_path, hdr.ff_tags.valid, meta.local_metadata.all_ports, meta.local_metadata.failure_visit, meta.local_metadata.first_visit, meta.local_metadata.if_out_failed, meta.local_metadata.is_completed, meta.local_metadata.out_port, meta.local_metadata.out_port_xor, meta.local_metadata.pkt_curr, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start, meta.local_metadata.starting_port, send_in_ingress_0.action_run, send_parent_0.action_run, set_out_port_0.action_run, standard_metadata.egress_spec, standard_metadata.ingress_port, start_bfs_0.action_run;
{
    ...
    call _curr_par_neq_in.action_run.limit();
    call _curr_par_eq_zero.action_run.limit();
    call _curr_par_eq_neq_ingress.action_run.limit();
    call _check_outport_status.action_run.limit();
    call _check_out_failed.action_run.limit();
    call start_bfs_0.action_run.limit();
    call set_out_port_0.action_run.limit();
    call send_parent_0.action_run.limit();
    call send_in_ingress_0.action_run.limit();
...
procedure send_in_ingress_0.action_run.limit();
    ensures(send_in_ingress_0.action_run==send_in_ingress_0.action.send_in);
	modifies send_in_ingress_0.action_run;

// Table send_in_ingress_0
procedure {:inline 1} send_in_ingress_0.apply()
	modifies forward, hdr.ff_tags.path_length, standard_metadata.egress_spec;
{

    call send_in_ingress_0.apply_table_entry();

    action_send_in:
    if(send_in_ingress_0.action_run == send_in_ingress_0.action.send_in){
        call send_in();
    }
}

// Table Entry send_in_ingress_0.apply_table_entry
procedure send_in_ingress_0.apply_table_entry();

// Table Exit send_in_ingress_0.apply_table_exit
procedure send_in_ingress_0.apply_table_exit();

// Action send_on_parent
procedure {:inline 1} send_on_parent()
	modifies forward, hdr.ff_tags.path_length, standard_metadata.egress_spec;
{
...
procedure send_parent_0.action_run.limit();
    ensures(send_parent_0.action_run==send_parent_0.action.send_on_parent);
	modifies send_parent_0.action_run;

// Table send_parent_0
procedure {:inline 1} send_parent_0.apply()
	modifies forward, hdr.ff_tags.path_length, standard_metadata.egress_spec;
{

    call send_parent_0.apply_table_entry();

    action_send_on_parent:
    if(send_parent_0.action_run == send_parent_0.action.send_on_parent){
        call send_on_parent();
    }
}

// Table Entry send_parent_0.apply_table_entry
procedure send_parent_0.apply_table_entry();

// Table Exit send_parent_0.apply_table_exit
procedure send_parent_0.apply_table_exit();
...
// Action set_bfs_tags
procedure {:inline 1} set_bfs_tags()
	modifies hdr.bfsTag.pkt_v1_par, hdr.ff_tags.bfs_start, meta.local_metadata.out_port, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start;
{
    meta.local_metadata.pkt_start := 1;
    hdr.ff_tags.bfs_start := meta.local_metadata.pkt_start;
    meta.local_metadata.pkt_par := 0;
    hdr.bfsTag.pkt_v1_par := meta.local_metadata.pkt_par;
    meta.local_metadata.out_port := 1;
}
...
procedure {:inline 1} start()
	modifies hdr.bfsTag.valid, hdr.ff_tags.valid, meta.local_metadata.pkt_curr, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start;
{
    hdr.ff_tags.valid := true;
    hdr.bfsTag.valid := true;
    meta.local_metadata.pkt_curr := hdr.bfsTag.pkt_v1_curr;
    meta.local_metadata.pkt_par := hdr.bfsTag.pkt_v1_par;
    meta.local_metadata.pkt_start := hdr.ff_tags.bfs_start;
    call accept();
}

procedure start_bfs_0.action_run.limit();
    ensures(start_bfs_0.action_run==start_bfs_0.action.set_bfs_tags);
	modifies start_bfs_0.action_run;

// Table start_bfs_0
procedure {:inline 1} start_bfs_0.apply()
	modifies hdr.bfsTag.pkt_v1_par, hdr.ff_tags.bfs_start, meta.local_metadata.out_port, meta.local_metadata.pkt_par, meta.local_metadata.pkt_start;
{

    call start_bfs_0.apply_table_entry();

    action_set_bfs_tags:
    if(start_bfs_0.action_run == start_bfs_0.action.set_bfs_tags){
        call set_bfs_tags();
    }
}

// Table Entry start_bfs_0.apply_table_entry
procedure start_bfs_0.apply_table_entry();

// Table Exit start_bfs_0.apply_table_exit
procedure start_bfs_0.apply_table_exit();

// Action towards_parent
procedure {:inline 1} towards_parent()
	modifies forward, hdr.bfsTag.pkt_v1_curr, hdr.ff_tags.path_length, standard_metadata.egress_spec;
{
    hdr.bfsTag.pkt_v1_curr := meta.local_metadata.pkt_curr;
    standard_metadata.egress_spec := meta.local_metadata.out_port;
    forward := true;
    hdr.ff_tags.path_length := add.bv8(hdr.ff_tags.path_length, 1);
}

...
function {:inline true} bsge.bv19(left:int, right:int) : bool{left >= right}
...
procedure {:inline 1} MyEgress()
	modifies hdr.ipv4.ecn;
{
    if(((hdr.ipv4.ecn == 1)) || ((hdr.ipv4.ecn == 2))){
        if(bsge.bv19(standard_metadata.enq_qdepth, 10)){
            call mark_ecn();
        }
    }
}
